...
abstract class DJIBaseStreamer(
    ...
    private val audioEncoderListener = object : IEncoderListener {
        ...
        override fun onOutputFrame(frame: Frame) {
            audioTsStreamId?.let {
                try {
                    this@DJIBaseStreamer.muxer.encode(frame, it)
                } catch (e: Exception) {
    ...
    override val settings = DJIBaseStreamerSettings(audioCapture, audioEncoder, videoEncoder)
