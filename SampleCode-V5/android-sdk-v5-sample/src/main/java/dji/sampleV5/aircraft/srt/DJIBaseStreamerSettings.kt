...
open class DJIBaseStreamerSettings(
    audioCapture: IAudioCapture?,
    audioEncoder: AudioMediaCodecEncoder?,
    videoEncoder: DJIVideoMediaCodecEncoder?
...
class BaseStreamerVideoSettings(private val videoEncoder: DJIVideoMediaCodecEncoder?) :
    IVideoSettings {
    /**
